#define CCD_FUNCTION(name) f32 name(sim_entity* SimEntityA, sim_entity* SimEntityB, collision_volume* VolumeA, collision_volume* VolumeB) 
...
CCD_FUNCTION(SphereSphereCCD)
{
    ...
    v3f MoveDeltaA = SimEntityA->GetMoveDelta();
    v3f MoveDeltaB = SimEntityB->GetMoveDelta();
...
{
    sphere SphereA = TransformSphere(&VolumeA->Sphere, SimEntityA->Transform);
    sqt    HullTransformB = ToParentCoordinates(VolumeB->ConvexHull->Header.Transform, SimEntityB->Transform);
    v3f    MoveDeltaA = SimEntityA->GetMoveDelta();
    v3f    MoveDeltaB = SimEntityB->GetMoveDelta();
...
{
    sqt    HullTransformA = ToParentCoordinates(VolumeA->ConvexHull->Header.Transform, SimEntityA->Transform);
    sphere SphereB = TransformSphere(&VolumeB->Sphere, SimEntityB->Transform);
    v3f MoveDeltaA = SimEntityA->GetMoveDelta();
    v3f MoveDeltaB = SimEntityB->GetMoveDelta();
...
{
    sphere SphereA   = TransformSphere(&VolumeA->Sphere, SimEntityA->Transform);
    sqt ConvexHullTransformB = ToParentCoordinates(VolumeB->ConvexHull->Header.Transform, SimEntityB->Transform);
...
{
    sphere SphereB   = TransformSphere(&VolumeB->Sphere, SimEntityB->Transform);
    sqt ConvexHullTransformA = ToParentCoordinates(VolumeA->ConvexHull->Header.Transform, SimEntityA->Transform);
...
#define CCD_CONTACT_FUNCTION(name) contact name(sim_entity* SimEntityA, sim_entity* SimEntityB, collision_volume* VolumeA, collision_volume* VolumeB, f32 tHit)
...
{
    sphere SphereA = TransformSphere(&VolumeA->Sphere, SimEntityA->Transform);
    sqt ConvexHullTransform = ToParentCoordinates(VolumeB->ConvexHull->Header.Transform, SimEntityB->Transform);
    SphereA.CenterP += SimEntityA->GetMoveDelta()*tHit;
...
{
    sqt ConvexHullTransform = ToParentCoordinates(VolumeA->ConvexHull->Header.Transform, SimEntityA->Transform);
    sphere SphereB = TransformSphere(&VolumeB->Sphere, SimEntityB->Transform);
